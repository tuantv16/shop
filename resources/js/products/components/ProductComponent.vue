  ...
  <script>
    ...
    export default {
        ...
        // async created() {
        //     this.fetchData('/api/some-endpoint').then((fetchedData) => {
        ...
        // },
         created() {
            this.fetchData();
            // try {
            //     this.data = await this.fetchData('/api/some-endpoint');
            // } catch (error) {
            //     console.error('Error fetching data:', error);
            // }
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap">
                        ...
                        <div class="add-product">
                            <a href="product-edit.html">Add Product22</a>
                        </div>
                        <table>
                            <tr>
                                <th>Image</th>
