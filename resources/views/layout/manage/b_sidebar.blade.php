        ...
        <ul class="metismenu" id="menu1">
            <li class="active">
                ...
                <ul class="submenu-angle" aria-expanded="true">
                    <li><a title="Danh sách danh mục" href="{{ url('/manage/categories')}}"><span class="mini-sub-pro">Danh sách danh mục</span></a></li>
                    <li><a title="Thêm danh mục" href="{{ url('/manage/categories/create')}}"><span class="mini-sub-pro">Thêm danh mục</span></a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow" href="index.html">
                ...
                <ul class="submenu-angle" aria-expanded="true">
                    <li><a title="Danh sách sản phẩm" href="{{ url('/manage/products')}}"><span class="mini-sub-pro">Danh sách sản phẩm</span></a></li>
                    <li><a title="Thêm sản phẩm" href="{{ url('/manage/products/create')}}"><span class="mini-sub-pro">Thêm sản phẩm</span></a></li>
                    <!--
