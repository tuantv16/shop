...
<head>
    ...
    <!-- Bootstrap CSS
		============================================ -->
     <link rel="stylesheet" href="{{ asset('manage/css/bootstrap.min.css') }}">
    <!-- Bootstrap CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/font-awesome.min.css') }}">
	<!-- nalika Icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/nalika-icon.css') }}">
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ asset('manage/css/owl.theme.css') }}">
    <link rel="stylesheet" href="{{ asset('manage/css/owl.transitions.css') }}">
    <!-- animate CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/animate.css') }}">
    <!-- normalize CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/normalize.css') }}">
    <!-- meanmenu icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/meanmenu.min.css') }}">
    <!-- main CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/main.css') }}">

    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/morrisjs/morris.css') }}">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/scrollbar/jquery.mCustomScrollbar.min.css') }}">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/metisMenu/metisMenu.min.css') }}">
    <link rel="stylesheet" href="{{ asset('manage/css/metisMenu/metisMenu-vertical.css') }}">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/calendar/fullcalendar.min.css') }}">
    <link rel="stylesheet" href="{{ asset('manage/css/calendar/fullcalendar.print.min.css') }}">
    <!-- style CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/style.css') }}">
    <!-- responsive CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('manage/css/responsive.css') }}">
    <!-- modernizr JS
		============================================ -->
    <script src="{{ asset('manage/js/vendor/modernizr-2.8.3.min.js') }}"></script>
...
<body>
        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="{{ asset('manage/img/notification/4.jpg') }}" alt="" /></a>
            ...
            @section('sidebar')
                @include('layout/manage/b_sidebar')
            @show
        </nav>
    </div>
    <!-- Start Welcome area -->
    ...
    <!-- jquery
		============================================ -->
    <script src="{{ asset('manage/js/vendor/jquery-1.12.4.min.js') }}"></script>
    <!-- bootstrap JS
		============================================ -->
    <script src="{{ asset('manage/js/bootstrap.min.js') }}"></script>
    <!-- wow JS
		============================================ -->
    <script src="{{ asset('manage/js/wow.min.js') }}"></script>
    <!-- price-slider JS
		============================================ -->
    <script src="{{ asset('manage/js/jquery-price-slider.js') }}"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="{{ asset('manage/js/jquery.meanmenu.js') }}"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="{{ asset('manage/js/owl.carousel.min.js') }}"></script>
    <!-- sticky JS
		============================================ -->
    <script src="{{ asset('manage/js/jquery.sticky.js') }}"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="{{ asset('manage/js/jquery.scrollUp.min.js') }}"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="{{ asset('manage/js/scrollbar/jquery.mCustomScrollbar.concat.min.js') }}"></script>
    <script src="{{ asset('manage/js/scrollbar/mCustomScrollbar-active.js') }}"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="{{ asset('manage/js/metisMenu/metisMenu.min.js') }}"></script>
    <script src="{{ asset('manage/js/metisMenu/metisMenu-active.js') }}"></script>
    <!-- sparkline JS
		============================================ -->
    <script src="{{ asset('manage/js/sparkline/jquery.sparkline.min.js') }}"></script>
    <script src="{{ asset('manage/js/sparkline/jquery.charts-sparkline.js') }}"></script>
    <!-- calendar JS
		============================================ -->
    <script src="{{ asset('manage/js/calendar/moment.min.js') }}"></script>
    <script src="{{ asset('manage/js/calendar/fullcalendar.min.js') }}"></script>
    <script src="{{ asset('manage/js/calendar/fullcalendar-active.js') }}"></script>
	<!-- float JS
		============================================ -->
    <script src="{{ asset('manage/js/flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('manage/js/flot/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('manage/js/flot/curvedLines.js') }}"></script>
    <script src="{{ asset('manage/js/flot/flot-active.js') }}"></script>
    <!-- plugins JS
		============================================ -->
    <script src="{{ asset('manage/js/plugins.js') }}"></script>
    <!-- main JS
		============================================ -->
    <script src="{{ asset('manage/js/main.js') }}"></script>
</body>
